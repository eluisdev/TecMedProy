...
export default function AdministradorOpciones() {
    ...
    return (
        <div className="my-5 px-5 flex flex-col gap-3 items-center">
            ...
            <Link
                className="text-centerw-full p-3 font-bold text-white hover:text-yellow-500 truncate rounded-xl max-md:w-96 max-sm:w-full flex gap-1 items-center justify-center"
                to="/administrador/activar-usuarios"
                onClick={() => changeView('activar usuarios')}
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <Link
                className="text-centerw-full p-3 font-bold text-white hover:text-yellow-500 truncate rounded-xl max-md:w-96 max-sm:w-full flex gap-1 items-center justify-center"
                to="/administrador/correspondencia_eliminada"
                onClick={() => changeView('correspondencia eliminada')}
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
            ...
            <Link
                className="text-centerw-full p-3 font-bold text-white hover:text-yellow-500 truncate rounded-xl max-md:w-96 max-sm:w-full flex gap-1 items-center justify-center"
                to="/administrador/caja-chica"
                onClick={() => changeView('caja chica')}
            >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
