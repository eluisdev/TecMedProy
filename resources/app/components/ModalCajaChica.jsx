...
import CajaChicaInformationPdf from "./CajaChicaInformacionPdf";


export default function ModalCajaChica() {

    const { changeStateModalCajaChica } = useProyect();
    ...
    return (
        ...
        <>
            <div className="flex justify-between items-center pb-3">
                ...
                <p className='font-bold uppercase text-2xl'>PDF gasto</p>

                <button onClick={changeStateModalCajaChica}>
